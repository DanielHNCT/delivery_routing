...
# 🧪 SCRIPT DE PRUEBA COMPLETA - FLUJO COLIS PRIVÉ
# Este script prueba el flujo completo: auth -> tournée
...
if [ -f .auth_token ]; then
    ...
    make_request "POST" "/api/colis-prive/tournee" "$tournee_data" "Obteniendo tournée con token"
